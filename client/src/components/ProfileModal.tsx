...
import { faXmark, faUser, faPenToSquare } from "@fortawesome/free-solid-svg-icons";
...
const ProfileModal: React.FC<ProfileModalProps> = ({ setProfile }) => {
  ...
  const avatarSrc = user?.avatar ? `/assets/img/user_avatar/${user.avatar}` : "/assets/img/user_avatar/user-avatar-1.png";
