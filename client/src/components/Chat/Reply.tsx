...
const Reply: React.FC<ReplyProps> = ({ senderName, text, setReply }) => {
  return (
    <div className="absolute w-[336px] bottom-14 flex items-start justify-between gap-2 p-2 border-l-4 border-emerald-500 bg-emerald-50 rounded-sm mb-2 animate-fadeIn [animation-fill-mode:backwards]">
