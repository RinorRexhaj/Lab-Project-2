      ...
      >
        <div className="w-full flex flex-col gap-6 border border-gray-300 bg-white rounded-lg px-8 py-10 shadow-md">
          ...
          <div className="w-full flex flex-col gap-1">
            ...
            <div>
              <input
                ...
                className="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-emerald-500"
              />
              <p className="text-red-500 font-semibold min-h-10 text-sm whitespace-normal break-words">
          ...
          <button
            type="submit"
            disabled={isDisabled()}
            className="h-10 px-3 py-2 mt-4 flex items-center justify-center bg-emerald-500 hover:bg-emerald-600 disabled:bg-emerald-200 disabled:cursor-not-allowed duration-150 rounded-md text-white font-semibold"
          >
            {loading ? (
